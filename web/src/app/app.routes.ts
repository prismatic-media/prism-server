  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'tv-shows',
        loadComponent: () =>
          import('./tv-shows/tv-shows.component').then((m) => m.TVShowsComponent),
      },
      {
        path: 'tv-shows/:id',
        loadComponent: () =>
      ...
      },
      {
        path: 'admin/storage',
        loadComponent: () =>
          import('./admin/storage/storage-admin.component').then((m) => m.StorageAdminComponent),
      },
      {
        path: 'admin/transcoding',
        loadComponent: () =>
          import('./admin/transcoding/transcoding-admin.component').then(
            (m) => m.TranscodingAdminComponent,
          ),
      },
      {
        path: 'admin/settings',
        loadComponent: () =>
          import('./admin/settings/settings-admin.component').then((m) => m.SettingsAdminComponent),
      },
    ],
  },
  {
