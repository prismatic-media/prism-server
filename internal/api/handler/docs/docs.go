    ...
    "paths": {
        "/../cast-receiver": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "HTML receiver page content",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/jobs/{id}/progress": {
            "get": {
                ...
                "responses": {
                    "101": {
                        "description": "Upgraded to WebSocket connection",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/media/{media_id}/subtitles": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.MediaSubtitle"
                            }
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "SRT subtitle file to upload",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    },
                    ...
                    {
                        "type": "string",
                        "description": "Display label for the subtitle track",
                        "name": "label",
                        "in": "formData",
                        "required": true
                    }
        ...
        "/media/{media_id}/subtitles/{subtitle_id}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/media/{media_id}/subtitles/{subtitle_id}:sync": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.SyncSubtitleRequest"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        "description": "Accepted background alignment or update complete",
                        "schema": {
                            "$ref": "#/definitions/models.MediaSubtitle"
                        }
                    },
                    ...
                    "404": {
                        "description": "Subtitle or media not found",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/tv-shows/{id}/backdrop": {
            "get": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Show or backdrop not found",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/tv-shows/{id}/extra-posters/{index}": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid index or show ID",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "404": {
                        "description": "Show or poster at index not found",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/tv-shows/{id}/poster": {
            "get": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Show or poster not found",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/tv-shows/{id}/seasons/{number}/poster": {
            "get": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Season or poster not found",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
